 ...
 * a JScrollPane.
 */
public class BarraLateral extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
     ...
     */
    public BarraLateral(JTextComponent component) {
        this(component, 3);
    }
     ...
     */
    public BarraLateral(JTextComponent component, int minimumDisplayDigits) {
